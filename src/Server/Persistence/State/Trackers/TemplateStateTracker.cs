...
public class TemplateStateTracker
{
    ...
    public TemplateStateTracker(EntityTable entityTable, StateManager stateManager)
    {
    ...
    private void OnTemplateSet(ulong entityId, ulong templateEntityId)
    {
        var update = new StateUpdate<ulong>
            { EntityId = entityId, StateUpdateType = StateUpdateType.Modify, Value = templateEntityId };
