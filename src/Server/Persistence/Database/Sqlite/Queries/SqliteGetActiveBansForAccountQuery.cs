...
/// <summary>
///     SQLite implementation of IGetActiveBansForAccountQuery.
/// </summary>
public class SqliteGetActiveBansForAccountQuery : IGetActiveBansForAccountQuery
{
    /// <summary>
    ///     SQL query.
    /// </summary>
    private const string Query =
        @"SELECT b.account_id, a.username, b.player_name, b.admin_name, b.created, b.duration_days
            ...
            WHERE b.account_id = @AccountId AND b.deleted = FALSE
            ORDER BY b.created";

    private readonly SqliteConnection connection;

    public SqliteGetActiveBansForAccountQuery(SqliteConnection connection)
    {
