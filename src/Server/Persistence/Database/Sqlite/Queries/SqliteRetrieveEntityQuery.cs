...
public sealed class SqliteRetrieveEntityQuery : IRetrieveEntityQuery
{
    ...
    private const string query =
        @"WITH RECURSIVE EntityTree(id, templateId, x, y, z, material, materialModifier, playerCharacter, name, account, 
	        ...
	        AS (
		        ...
		        UNION ALL
            		SELECT ec.id, ec.templateId, ec.x, ec.y, ec.z, ec.material, ec.materialModifier, ec.playerCharacter,
            ...
            SELECT id, templateId, x, y, z, material, materialModifier, playerCharacter, name, account, parent, drawable,
