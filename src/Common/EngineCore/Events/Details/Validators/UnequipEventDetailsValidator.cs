...
/// <summary>
///     Validates UnequipEventDetails objects. PlayerEntityId is not validated because it is
///     overwritten by the server with the authenticated player's entity ID.
/// </summary>
public class UnequipEventDetailsValidator : IEventDetailsValidator
{
    public bool IsValid(IEventDetails? details)
    {
        return details is UnequipEventDetails
        {
            TargetSlotIndex: >= 0,
