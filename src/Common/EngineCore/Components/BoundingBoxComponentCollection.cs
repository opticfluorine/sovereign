...
/// <summary>
///     Component collection for the BoundingBox component which specifies the bounding box used by a
///     non-block physics entity.
/// </summary>
public class BoundingBoxComponentCollection : BaseComponentCollection<BoundingBox>
{
