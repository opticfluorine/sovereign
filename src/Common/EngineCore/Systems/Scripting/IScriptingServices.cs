...
/// <summary>
///     Interface for Scripting system services.
/// </summary>
public interface IScriptingServices
{
    /// <summary>
    ...
    bool TryGetHostForState(IntPtr luaState, [NotNullWhen(true)] out LuaHost? host);
    ...
    ILogger GetScriptLogger(IntPtr luaState, ILogger fallback);
    ...
    ScriptInfo GetLoadedScriptInfo();
}